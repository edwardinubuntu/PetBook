...
import com.edinubuntu.petlove.fragment.MarketSourceFragment;
...
public class MarketActivity extends SherlockFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().replace(R.id.content_frame, new MarketSourceFragment()).commit();
    }
